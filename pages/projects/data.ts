export const projects = [
	{
		title: 'Daydent',
		description:
			'Daydent é uma plataforma para gestão de agenda odontológica para UBS.',
	...
	},
	{
		title: 'My Awesome',
		description:
			'Open-source project to create lists with your favorite links and content',
		image: 'https://i.imgur.com/SkEcNJj.jpg',
	...
	},
	{
		title: 'EcoNext',
		description:
			'The EcoNext project aims to connect entities, companies and people to assist in the disposal of organic and inorganic waste.',
		image: 'https://i.imgur.com/SkEcNJj.jpg',
